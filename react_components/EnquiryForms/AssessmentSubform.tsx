...
import mypic from "../../public/Assets/Contact-Form-Picture.jpg"
...
const AssessmentSubForm = () => {
    const [formtype, setForm] = useState("Assessment Booking");
...
async function preparetosend(){
  ...
  return (
    ...
    <label >Name:</label>
      <input required className={styles.textarea1} value={name} onChange={(e)=>{setName(e.target.value)}} />
      ...
      <input  required className={styles.input1} value={childname} onChange={(e)=>{setChildname (e.target.value)}} />
      
      </div>

      <div className={styles.formitem1}>
      <label >Age of your child:</label>
      <input  required className={styles.input1} value={age} onChange={(e)=>{setAge(e.target.value)}} />
      
      </div>
      <div className={styles.formitem1}>
      <label >Concerns:</label>
      <textarea  required className={styles.input1} value={concerns} onChange={(e)=>{setConcerns (e.target.value)}} />
...
export default AssessmentSubForm